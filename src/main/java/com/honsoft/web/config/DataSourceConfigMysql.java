...
@MapperScan(value = {
		"com.honsoft.web.mapper.mysql" }, sqlSessionFactoryRef = "mysqlSqlSessionFactory", nameGenerator = UniqueNameGenerator.class)
...
public class DataSourceConfigMysql {
	...
	public LocalContainerEntityManagerFactoryBean mysqlEntityManagerFactory() {
		...
		jpaProperties.put("hibernate.dialect", env.getProperty("mysql.datasource.dialect"));
