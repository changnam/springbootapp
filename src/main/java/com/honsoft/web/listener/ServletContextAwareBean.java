...
public class ServletContextAwareBean implements ServletContextAware {
	...
	public void setServletContext(ServletContext servletContext) {
		...
		for (String servletName : servletRegistrations.keySet()) {
			// System.out.println("==> "+);
			logger.info("name: " + servletName + " , class: " + servletRegistrations.get(servletName).getClassName()
					+ " , mapping: " + servletRegistrations.get(servletName).getMappings());
		}
		logger.info("--------------------------------------------------------------");
		...
		for (String filterName : filterRegistrations.keySet()) {
			// System.out.println("==> "+);
			logger.info("name: " + filterName + " , class: " + filterRegistrations.get(filterName).getClassName()
					+ " , mapping: " + filterRegistrations.get(filterName).getUrlPatternMappings()
					+ filterRegistrations.get(filterName).getServletNameMappings());
		}
