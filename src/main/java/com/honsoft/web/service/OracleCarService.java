...
import com.honsoft.web.mapper.oracle.CarMapper;
import com.honsoft.web.repository.oracle.CarRepository;

@Service
public class OracleCarService {
	private Logger logger = LoggerFactory.getLogger(OracleCarService.class);
